...
export const SUIKODEN_NEWS_ITEMS = [
  {
    ...
    body: "코나미가 Star Leap와 시리즈 전개를 다루는 생방송을 예고했습니다.",
  ...
  },
  {
    ...
    body: "환상수호전 II 기반 애니메이션의 새 영상과 방영 시기 관련 정보가 공개됐습니다.",
  ...
  },
  {
    ...
    body: "리마스터판의 Nintendo Switch 2 대응 소식과 출시 일정이 정리됐습니다.",
  ...
  },
  {
    ...
    body: "코나미가 모바일 신작 Star Leap를 발표하며 시리즈의 새 전개를 알렸습니다.",
  ...
  },
  {
    ...
    body: "환상수호전 I·II 리마스터의 출시일과 플랫폼 정보가 공개됐습니다.",
