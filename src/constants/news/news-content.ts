...
export const SUIKODEN_NEWS_ITEMS = [
  {
    date: "Jul 08, 2026",
    title: "Suikoden STAR LEAP Fortune Campaign Opens",
    body: "스타 리프 사전등록 기념 웹 이벤트가 시작되며 캐릭터 운세와 선물 캠페인이 함께 공개됐습니다.",
    href: "https://www.konami.com/games/suikoden/star_leap/jp/ja/cp_fortune-telling",
    outlet: "KONAMI",
    tag: "Star Leap",
  },
  {
    date: "Jul 08, 2026",
    title: "Symphonic Poem from Suikoden Voyage Announced",
    body: "환상수호전 음악을 다루는 심포닉 공연 소식이 공식 포털의 최신 이벤트 항목으로 공개됐습니다.",
    href: "https://www.konami.com/games/suikoden/ja/",
    outlet: "KONAMI",
    tag: "Event",
  },
  {
    ...
    href: "https://www.konami.com/games/suikoden/star_leap/jp/ja/",
    outlet: "KONAMI",
    tag: "Star Leap",
  },
  {
    date: "Jul 02, 2026",
    title: "Suikoden STAR LEAP Pre-Registration Begins",
    body: "코나미가 iOS와 Android판 사전등록 시작을 알리며 스타 리프의 정사 신작 정보를 정리했습니다.",
    href: "https://www.konami.com/games/corporate/ja/news/topics/20260702s/",
    outlet: "KONAMI",
    tag: "Star Leap",
  },
  {
