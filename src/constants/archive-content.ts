...
export const IMAGE_PATHS = {
  ...
  worldMap: "/suikoden/genso-world-guide-map-korean.jpg",
} as const;
...
export const REGION_ATLAS_LOCATIONS = [
  ...
  },
  {
    ...
    ruling: "사우스 윈도우 도시국가",
    rune: "-",
    description: "사우스 윈도우 권역의 항구 마을입니다. 코로넷에서 이어지는 호수 이동 후 남부 도시국가권에 들어서는 지점입니다.",
...
export const REGION_KOREAN_NAMES = {
  ...
  tinto: "틴토",
  crom: "크롬 마을",
  "tigermouth-village": "호랑이 입 마을",
  "drakemouth-village": "용의 입 마을",
  sajah: "사자 마을",
  lrnouille: "황도 루루노이에",
} as const;
